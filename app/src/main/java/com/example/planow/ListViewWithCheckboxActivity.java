...
public class ListViewWithCheckboxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectRemoveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.setMessage("Видалити вибране?");

                alertDialog.setButton(Dialog.BUTTON_POSITIVE, "Підтвердити", new DialogInterface.OnClickListener() {
                    @Override
    ...
    {
        String itemTextArr[] = {"Проект по хмарах", "БД", "Вивчити Java",
                "JavaScript", "Конференцію", "Вигуляти собаку", "Встановити Linux",
                "Python", "Servlet", "Windows"};
